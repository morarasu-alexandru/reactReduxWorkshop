...
const initialState = {
  "1": [
      {step: "1. Create increment action | (src/actions/1/counter.js)", isDone: false},
      {step: "2. Add increment case in reducer | (src/reducers/1/counter.js)", isDone: false},
  ...
  "2": [
    ...
    {step: "2. Import 'changeInput' action from src/actions/2/input.js on the component | (same path as above)", isDone: false},
    ...
    {step: "4. We will notice that will still not work, we have to treat the case we have dispatched the 'changeInput' action within the input reducer | (src/reducers/2/i7nput.js)", isDone: false}
  ],
  "3": [
    {step: "1. Create addTodo action using as action type | (src/actions/3/todo.js) ", isDone: false},
    {step: "2. Handle addTodo case in reducer | (src/reducers/3/todo.js)", isDone: false},
  ...
  "4": [
    ...
    {step: "3. Handle the action types in the reducer accordingly, one action is to start loading and the other one is to load the data and stop loading | (src/reducers/4/posts)", isDone: false},
  ...
  "5": [
    {step: "1. Observe the actions/reducers, they are ok in this form | (src/reducers/animation.js and src/actions/5/animate.js)", isDone: false},
    {step: "2. Extend handleAnimationClick function from the component, please note that one animation takes 1000ms or 1 second | (src/containers/exercise/5/index.js)", isDone: false},
